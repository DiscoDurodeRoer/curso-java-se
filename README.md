...
Video en [youtube](https://youtu.be/Bcij5osidEs)
...
Video en [youtube](https://youtu.be/JHdLb9TtUXs)
...
51. Crea una baraja de cartas y muestra cada una de las cartas

[Resolucion](https://youtu.be/pIwsKhmMmFw)

52. Teniendo una cola de personas de un cine.
...
[Resolucion](https://youtu.be/uGlKBKZC5G8)

53. Teniendo una cola de personas de un cine.
...
[Resolucion](https://youtu.be/UPL7iHShS1o)

54. Teniendo una cola de personas de un cine.
...
[Resolucion](https://youtu.be/tNYmn_SR0e4)

55. Gestionar una lista de productos en un sistema de compras.

Se podra hacer lo siguiente:

- Añadir producto: El sistema debe permitir al usuario elegir entre tres productos predefinidos:
...
- Mostrar productos: El sistema debe mostrar todos los productos añadidos hasta el momento, mostrando su nombre y precio. Muestra el total

- Eliminar producto: El sistema debe permitir al usuario elegir un producto de la lista para eliminarlo, solicitando al usuario que ingrese el número del producto que desea eliminar.

- Eliminar todos los productos: El sistema debe permitir limpiar la lista de productos, eliminando todos los productos almacenados.

- Salir: El sistema debe permitir al usuario salir del programa.

[Resolucion](https://youtu.be/4fJgslDqRXk)

56. Vamos a manejar una serie de contactos que contienen nombre y telefono.
...
- Mostrar contactos ordenados: Muestra los contactos ordenados por nombre sin modificar el original

- Eliminar contacto: Pedimos un nombre y eliminamos un contacto

[Resolucion](https://youtu.be/owf2fcf69CI)

57.  Vamos a gestionar una serie de productos por categorias

Tenemos 3 categorias: ropa, electrodomesticos y alimentos

Las acciones que se pueden realizar son:

- Agregar producto a una categoría: Pedimos una categoria, pedimos los datos de un producto y añadimos

- Mostrar productos por categoría: Pedimos una categoria y mostramos los productos de esa categoria

- Eliminar producto de una categoría: Pedimos una categoria, elegimos uno de los productos y lo eliminamos

- Mostrar categorias

- Mostrar el numero de productos por categorias

[Resolucion](https://youtu.be/KEBWRYmowbE)
